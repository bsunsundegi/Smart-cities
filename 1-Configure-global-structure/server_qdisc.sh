...
iptables -t mangle -A FORWARD -p tcp --dport 8080 -o $interface_gateway -j MARK --set-mark 10
iptables -t mangle -A FORWARD -p tcp --dport 8080 -o $interface_gateway -j RETURN
...
iptables -t mangle -A OUTPUT -p tcp --dport 8080 -o $interface_gateway -j MARK --set-mark 10
iptables -t mangle -A OUTPUT -p tcp --dport 8080 -o $interface_gateway -j RETURN
